...
const AllergyImmunoCosts: React.FC = () => {
  return (
    <div>
      <BlogHero
        imgSrc="/YellowSyringes.avif"
        imgAlt="Syringes on a yellow background representing allergy shots"
      ...
      <section className="blog-main-content">
        <div className="blog-content-block">
          <p>Allergy immunotherapy is a long-term treatment that can reduce the immune response to indoor and outdoor allergens.&nbsp;</p>
          <p>Doses are administered by <a href="https://getcurex.com/allergy-shots" target="_blank" rel="noopener noreferrer">allergy shots</a> or under the tongue. Treatments are tailored to individual test results, allergies and patient needs.&nbsp;</p>
          <p>Depending on your health insurance plan, allergy immunotherapy may cost as little as a copay (or nothing if your health insurance provider covers allergy immunotherapy). But those without health insurance or high deductibles may shy away from this type of treatment, as allergy immunotherapy can cost upwards of thousands of dollars out of pocket.&nbsp;</p>
          <p>So how much do allergy shots cost, anyway? Is allergy medication more expensive than allergy immunotherapy in the long run? And is under-the-tongue allergy immunotherapy less expensive than its in-office cousin?&nbsp;</p>
        </div>
        <h2 className="blog-section-title">What You Need to Know About the Price of Allergy Shots</h2>
        <div className="blog-content-block">
          <p>The cost of allergy immunotherapy depends on your provider, insurance and type of immunotherapy.&nbsp;</p>
          <p>Allergy shots are more common in the U.S. than other types of allergy immunotherapy (though <a href="https://getcurex.com/sublingual-immunotherapy" target="_blank" rel="noopener noreferrer">sublingual immunotherapy</a> is more common in Europe, particularly France).&nbsp;</p>
        </div>
        ...
        <div className="blog-image-block">
          <img src="https://cdn.prod.website-files.com/61bcf7a199a6ef4fbfb9ee04/65721de15606a25a1ddbb6c1_Untitled-1.avif" alt="doctor administering allergy shots to a patient" className="blog-image" loading="lazy" />
        </div>
        <h2 className="blog-section-title">The True Cost of Allergy Shots: Time</h2>
        <div className="blog-content-block">
        ...
        <div className="blog-image-block">
          <img src="https://cdn.prod.website-files.com/61bcf7a199a6ef4fbfb9ee04/65721e47b43ca94273fc5b63_untitled-2.avif" alt="doctor and patient looking at medical bills indicating allergy shots price" className="blog-image" loading="lazy" />
        </div>
        <h2 className="blog-section-title">How much does over-the-counter allergy medication cost?</h2>
        <div className="blog-content-block">
          <a href="https://www.forbes.com/health/body/best-allergy-medicine/" target="_blank" rel="noopener noreferrer">Over-the-counter allergy medication costs</a> vary, depending on the type of medication and the manufacturer.
          <p>Most prescription allergy medications are also available over the counter, too. Depending on your health insurance, you may end up paying less out of pocket if you purchase over-the-counter medications.</p>
          <p>The most common over-the-counter allergy medications include antihistamines (oral tablets, nasal sprays and eye drops), steroid nasal sprays, and saline sprays and drops.&nbsp;</p>
          <p>Many name-brand allergy medications cost around $20 a month.</p>
          <p>Side effects such as drowsiness can be one of the main downsides to using allergy medications.</p>
        </div>
        <h2 className="blog-section-title">Antihistamine Costs</h2>
        <div className="blog-content-block">
        ...
        <h4 className="blog-subsection-title">Claritin (Loratadine)</h4>
        <div className="blog-content-block"><p>$19.99 for 30 tablets ($0.67/tablet)</p></div>
        <h4 className="blog-subsection-title">Zyrtec (Cetirizine HCl)</h4>
        <div className="blog-content-block"><p>$18.99 for 30 tablets ($0.63/tablet)</p></div>
        <h4 className="blog-subsection-title">Allegra (Fexofenadine Hydrochloride)</h4>
        <div className="blog-content-block"><p>$17.99 for 30 tablets ($0.60/tablet)</p></div>
        <h4 className="blog-subsection-title">Xyzal (Levocetirizine)</h4>
        <div className="blog-content-block"><p>$35.49 for 80 tablets ($0.44/tablet)</p></div>
        <h4 className="blog-subsection-title">Generic Brand Antihistamines</h4>
        <div className="blog-content-block"><p>Generic antihistamines usually cost anywhere between $3.99 and $6.99 per bottle.&nbsp;</p></div>
        <h3 className="blog-subsection-title">Steroid Nasal Sprays</h3>
        <div className="blog-content-block"><p>Several steroid nasal sprays are available both over the counter and with a prescription.</p></div>
        <h4 className="blog-subsection-title">Flonase</h4>
        <div className="blog-content-block"><p>$14.99 for 72 sprays</p></div>
        <h4 className="blog-subsection-title">Nasacort</h4>
        <div className="blog-content-block"><p>$17.99 for 120 sprays</p></div>
        <h3 className="blog-subsection-title">Decongestant Prices</h3>
        <div className="blog-content-block">
          <p>Decongestants range in price from $4 to $20, depending on the brand, dosage, and product count.&nbsp;</p>
          <p>These medications are generally available over the counter, but your provider may also write a prescription for a stronger decongestant.&nbsp;</p>
          <p>Decongestants are also used in combination with antihistamine-decongestant pills your provider may recommend for chronic or acute nasal congestion, sinus pressure or postnasal drip.&nbsp;</p>
        </div>
        <h2 className="blog-section-title">Asthma-Related Medication Costs</h2>
        <div className="blog-content-block">
          <p>People with <a href="https://my.clevelandclinic.org/health/diseases/21461-allergic-asthma" target="_blank" rel="noopener noreferrer">asthma also often suffer from allergies</a> because asthma is part of the spectrum of allergy diseases.&nbsp;</p>
        </div>
        <h3 className="blog-subsection-title">Inhalers Costs</h3>
        <div className="blog-content-block">
          <p>The cost of bronchodilator and asthma inhalers such as Albuterol, Flovent, Symbicort and Advair, can vary based on your prescription medicine insurance plan. If you have pharmacy benefits, the cost can be up to several hundred dollars for one inhaler. Their generic counterparts cost between $30 and $75 per inhaler.&nbsp;</p>
        </div>
        <h3 className="blog-subsection-title">Anti-Inflammatory Tablets&nbsp;</h3>
        <div className="blog-content-block">
          <p>Anti-inflammatory tablets, such as montelukast cost a little more than $10 for a 30-day supply of 10 mg tablets.&nbsp;</p>
          <p>Singulair, the brand name of montelukast tablets, can cost nearly $250 for a 30-day supply of 10 mg tablets.&nbsp;</p>
          <p>Again costs can vary based on your individual benefits.&nbsp;</p>
        </div>
        ...
        <h3 className="blog-subsection-title">Dog and Cat Allergy Shots Costs</h3>
        <div className="blog-content-block">
          <p>Allergy shots for <a href="https://getcurex.com/blog-posts/pet-allergies" target="_blank" rel="noopener noreferrer">pet allergies</a> cost about the same as allergy shots for pollen, pests and grasses.</p>
          <p>Typically these allergens can be mixed together and given together in one or more shots.&nbsp;</p>
          <p>Depending on which allergens you and your medical provider are targeting, it could cost up to $75 per visit without insurance.&nbsp;&nbsp;</p>
        </div>
        <h3 className="blog-subsection-title">Sublingual Allergy Immunotherapy Costs</h3>
        <div className="blog-content-block">
          <p>Sublingual allergy immunotherapy generally costs between $65 per month and $150 per month depending on the type of sublingual therapy and your insurance. With that said, Curex takes pride in being the most affordable <a href="https://getcurex.com/sublingual-immunotherapy" target="_blank" rel="noopener noreferrer">sublingual immunotherapy</a> provider by offering a $49/month + copay insurance plan or a $99/month self-pay plan, with further discounts on annual subscriptions.</p>
          <p>One of the benefits of sublingual allergy immunotherapy is that this type of immunotherapy may be self-administered at home. Since anaphylaxis is rarer with sublingual allergy immunotherapy, you may not need to administer the doses under the supervision of a medical professional.</p>
          <p>Sublingual allergy immunotherapy is administered once a day. Missing a dose may not set you back as much as missing doses of subcutaneous allergy immunotherapy, either. If you miss a dose, touch base with your allergy provider about the next steps, but usually you will simply resume your daily medication.&nbsp;</p>
          <p>When you sign up with Curex, you receive immunotherapy medication with free allergy testing at home; talk or text with your clinician, as needed, and get access to low allergy, asthma and eczema medication prices and delivery.</p>
          <p>Get a long-term solution to your allergy or asthma symptoms with at-home immunotherapy for $75 per month. You can get started by taking our free quiz, or chatting with a care manager, to answer any questions you might have.</p>
        </div>
        <h2 className="blog-section-title">FAQs</h2>
        <h3 className="blog-subsection-title">Are allergy shots expensive?</h3>
        <div className="blog-content-block">
          <p>Depending on your insurance coverage, allergy shots can cost anywhere from $100-$150 per visit depending on your insurance coverage. In addition, lost wages and commuting costs can add up, making allergy shots a very expensive option for many people. Sublingual immunotherapy can be a great alternative to costly allergy shots with the current prices of Curex.</p>
        </div>
        <h3 className="blog-subsection-title">What is the cost of allergy injections?</h3>
        <div className="blog-content-block">
          <p>Each dose is usually around $100 excluding administration costs.</p>
        </div>
        <h3 className="blog-subsection-title">Does insurance cover allergy shots?</h3>
        <div className="blog-content-block">
          <p>Insurance typically covers allergy shots, however, your out-of-pocket responsibility is determined by many factors including your copay, deductible and more.</p>
        </div>
      </section>
    </div>
  );
...
export default AllergyImmunoCosts;
